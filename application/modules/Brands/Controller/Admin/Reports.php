...
class Reports extends Crud
{
    ...
    public function allBrandsAction()
    {
        ...
        $form = new Form(module_path('Brands', '/Resources/forms/admin/reports-all-brands-filters.php'));
        ...
        $grid = new Grid($brandsModel, module_path('Brands', '/Resources/grids/admin/reports/all-brands.php'));
