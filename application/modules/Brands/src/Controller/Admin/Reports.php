...
class Reports extends Crud
{
    ...
    public function allBrandsAction()
    {
        ...
        $form = new Form(module_path('Brands', '/forms/admin/reports-all-brands-filters.php'));
        ...
        $grid = new Grid($brandsModel, module_path('Brands', '/grids/admin/reports/all-brands.php'));
    ...
    public function brandsAction()
    {
        ...
        $form = new Form(module_path('Brands', '/forms/admin/reports-brands-filters.php'));
