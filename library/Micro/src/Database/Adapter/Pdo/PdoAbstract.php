...
abstract class PdoAbstract extends AdapterAbstract
{
    /**
     ...
     * @var string
     */
    protected $_defaultStmtClass = 'Micro\Database\Statement\Pdo';
    ...
    public function prepare($sql)
    {
        ...
        if (!class_exists($stmtClass)) {
            throw new \Exception("Class {$stmtClass} does not exists.");
        }
     ...
     *                      May be a string or \Micro\Database\Select.
